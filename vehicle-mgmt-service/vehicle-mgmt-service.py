...
def create_vehicle(vehicle: Vehicle):
    ...
    cursor.execute(
        ...
        (vehicle.id, vehicle.make, vehicle.model, vehicle.year, vehicle.price, vehicle.fuel_type, vehicle.transmission, vehicle.body_type, vehicle.image_url)
    )
    conn.commit()
    conn.close()
...
def update_vehicle(vehicle_id: str, vehicle: Vehicle):
    ...
    cursor.execute(
        ...
        (vehicle.make, vehicle.model, vehicle.year, vehicle.price, vehicle.fuel_type, vehicle.transmission, vehicle.body_type, vehicle.image_url, vehicle_id)
    )
    conn.commit()
    conn.close()
...
def list_vehicles():
    ...
    return [{"id": v[0], "make": v[1], "model": v[2], "year": v[3], "price": v[4], "fuel_type": v[5], "transmission": v[6], "body_type": v[7], "image_url": v[8]} for v in vehicles]
...
def get_vehicle(vehicle_id: str):
    ...
    return {"id": vehicle[0], "make": vehicle[1], "model": vehicle[2], "year": vehicle[3], "price": vehicle[4], "fuel_type": vehicle[5], "transmission": vehicle[6], "body_type": vehicle[7], "image_url": vehicle[8]}
